...
| Cache reuse | `--cache-reuse` | `256` | Cross-divergence KV reuse optimization. Multimodal models may reject it; ordinary text prefix caching through prompt cache remains active. |
