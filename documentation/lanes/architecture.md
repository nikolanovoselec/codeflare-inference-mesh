...
9. Admin observes readiness, mesh health, and active profiles on the dashboard — a live hub-and-spoke topology, node and model drawers, a stats strip, a sortable nodes table, and a smoothed tokens-per-second trace refreshed by visibility-aware five-second polling — and can verify inference from the playground, which streams a prompt through the live AI Gateway route. ([REQ-OBS-002](../../sdd/spec/observability.md)) ([REQ-OBS-007](../../sdd/spec/observability.md)) ([REQ-OBS-010](../../sdd/spec/observability.md)) ([REQ-ADM-015](../../sdd/spec/setup-admin.md)) ([REQ-ADM-016](../../sdd/spec/setup-admin.md)) ([REQ-ADM-007](../../sdd/spec/setup-admin.md))
