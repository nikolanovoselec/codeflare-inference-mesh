...
7. The vLLM runtime surfaces plain-repository guidance in the model-sources panel, whose reference example and input placeholder carry no quant suffix. <!-- @impl: packages/router-worker/src/admin-ui-views.ts::addModelCard --> <!-- @impl: packages/router-worker/src/admin-ui-css.ts::adminUiCss --> <!-- @impl: packages/router-worker/src/admin-ui-client.ts::ADMIN_UI_CLIENT_SCRIPT --> <!-- @test: packages/router-worker/src/admin-ui-mesh-console.test.ts (REQ-ADM-025 switches model guidance to plain-repo format when the vLLM runtime is selected) -->
