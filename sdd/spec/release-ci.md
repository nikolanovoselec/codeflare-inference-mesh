...
6. Dependency update pull requests cover npm workspaces, the node-agent Go module, and GitHub Actions. <!-- @impl: .github/dependabot.yml --> <!-- @test: packages/router-worker/src/workflows.test.ts (REQ-REL-001 opens dependency update pull requests for supported package ecosystems) -->
