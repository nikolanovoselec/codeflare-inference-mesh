...
| `splitReadiness` | MeshLLM planner diagnostic for split profiles, including capacity advice, participants, blockers, and recommendations when the planner cannot place the model. |
