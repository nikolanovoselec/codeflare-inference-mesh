...
1. Admin opens the bootstrap origin; the wizard claims the deployment, provisions the custom domain, and provisions role-gated Cloudflare Access plus machine-path bypass, advancing setup through its phases to `complete` before handing off. The bootstrap origin then serves only a console-moved page. (Access policy shape and role gating: [security.md](security.md#role-based-console-access).) ([REQ-ADM-011](../../sdd/spec/setup-admin.md)) ([REQ-ADM-012](../../sdd/spec/setup-admin.md)) ([REQ-SEC-010](../../sdd/spec/security.md)) ([REQ-ADM-014](../../sdd/spec/setup-admin.md))
...
9. Admin observes the mesh on the dashboard — hub-and-spoke topology, node and model drawers, a stats strip, a sortable nodes table, and a smoothed tokens-per-second trace on visibility-aware five-second polling — and verifies inference from the playground through the AI Gateway route. ([REQ-OBS-002](../../sdd/spec/observability.md)) ([REQ-OBS-007](../../sdd/spec/observability.md)) ([REQ-OBS-010](../../sdd/spec/observability.md)) ([REQ-ADM-015](../../sdd/spec/setup-admin.md)) ([REQ-ADM-016](../../sdd/spec/setup-admin.md)) ([REQ-ADM-007](../../sdd/spec/setup-admin.md))
