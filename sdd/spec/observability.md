...
7. Mesh health entries carry member-reported split-readiness blockers such as `split_capacity_shortfall`, resolve MeshLLM participant IDs to Codeflare machine names when possible, and the Admin UI renders split readiness as structured status/participant rows without visible planner capacity byte totals, instead of a single raw sentence or green standby/API-client label. <!-- @impl: packages/router-worker/src/mesh-state.ts::meshHealth --> <!-- @impl: packages/router-worker/src/admin-ui-client.ts::buildMeshCard --> <!-- @impl: packages/router-worker/src/admin-ui-client.ts::nodeStatusText --> <!-- @test: packages/router-worker/src/mesh-state.test.ts (REQ-OBS-007 carries split readiness blockers and machine names into mesh health) --> <!-- @test: packages/router-worker/src/admin-ui-dashboard.test.ts (REQ-OBS-007 surfaces split capacity shortfall instead of marking raw standby green) --> <!-- @test: packages/router-worker/src/admin-ui-mesh.test.ts (REQ-OBS-007 renders split capacity shortfall as structured mesh detail) -->
