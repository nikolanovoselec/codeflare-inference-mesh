...
| `WORKER_BASE_URL` | optional bootstrap origin override | no; request origin is used when unset or still a placeholder | `packages/router-worker/src/router.ts::handleCustomDomain`, `packages/router-worker/src/router.ts::handleGatewaySync`, `packages/router-worker/src/router.ts::handleInstaller` | [REQ-ADM-004](../../sdd/spec/setup-admin.md), [REQ-ADM-005](../../sdd/spec/setup-admin.md), [REQ-REL-005](../../sdd/spec/release-ci.md#req-rel-005-deploy-execution-safety) |
