...
2. Admin uses command-center controls to configure AI Gateway provider and route automation. ([REQ-GWY-003](../../sdd/spec/gateway.md)) ([REQ-ADM-006](../../sdd/spec/setup-admin.md))
