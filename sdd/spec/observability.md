...
1. Audit events record setup, claim, unregister, revoke, admin recovery reset, route provisioning, profile addition, profile switch, and Gateway sync failure actions. <!-- @impl: packages/router-worker/src/router.ts::ROUTER_ANCHORS --> <!-- @impl: packages/router-worker/src/router.ts::handleAdminRecovery --> <!-- @impl: packages/router-worker/src/router.ts::handleGatewaySync --> <!-- @impl: packages/router-worker/src/router.ts::handleProfileAdd --> <!-- @impl: packages/router-worker/src/router.ts::handleApiModelAdd --> <!-- @test: packages/router-worker/src/router.test.ts (REQ-OBS-006 records audit events for setup, claim, unregister, revoke, route provisioning, and profile switch actions) --> <!-- @test: packages/router-worker/src/router.test.ts (REQ-RUN-011 records a profile-added audit event on a successful add) --> <!-- @test: packages/router-worker/src/router.test.ts (REQ-OBS-006 records a profile-added audit event for programmatic model onboarding) --> <!-- @test: packages/router-worker/src/router.test.ts (REQ-ADM-002 recovers a lost admin token only with the recovery secret) --> <!-- @test: packages/router-worker/src/router.test.ts (REQ-ADM-019 surfaces an actionable message when Gateway sync fails) -->
