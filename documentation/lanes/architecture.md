...
2. Admin uses command-center controls to configure AI Gateway provider and route automation. ([REQ-GWY-003](../../sdd/spec/gateway.md)) ([REQ-ADM-007](../../sdd/spec/setup-admin.md))
3. Admin creates a one-time setup token from the command center. ([REQ-ADM-003](../../sdd/spec/setup-admin.md)) ([REQ-ADM-007](../../sdd/spec/setup-admin.md))
