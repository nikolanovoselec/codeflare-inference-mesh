...
| Data plane | Node selection, body rewriting, Mesh forwarding, and the direct-session affinity that picks a cache-warm node for direct llama.cpp profiles. | `packages/router-worker/src/inference.ts` | [REQ-RTR-002](../../sdd/spec/router-worker.md), [REQ-SCH-002](../../sdd/spec/state-scheduling.md) |
