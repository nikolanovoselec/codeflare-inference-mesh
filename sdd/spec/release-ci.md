...
2. Deploy creates a checksums file covering every uploaded archive and removes raw platform binaries before release upload. <!-- @impl: .github/workflows/deploy.yml::REL003ReleaseArtifacts --> <!-- @test: packages/router-worker/src/workflows.test.ts (REQ-REL-003 builds cross-platform release assets, manifest, optional signature, and GitHub Release) -->
