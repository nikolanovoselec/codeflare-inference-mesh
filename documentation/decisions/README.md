...
| [AD-010](#ad-010-public-release-artifacts-after-mesh-proof) | Accepted | Publish public GitHub Release artifacts for installers and self-update after the first Worker path is proven. | [REQ-REL-003](../../sdd/spec/release-ci.md#req-rel-003), [REQ-NODE-005](../../sdd/spec/node-agent.md#req-node-005) |
