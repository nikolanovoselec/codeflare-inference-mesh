...
| Speed test | Measures one streamed request through the real forward path and stores the result per resolved profile. | `packages/router-worker/src/speed-test.ts` | [REQ-ADM-016](../../sdd/spec/setup-admin.md) |
