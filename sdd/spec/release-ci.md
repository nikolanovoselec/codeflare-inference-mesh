...
4. Workflow safety checks reject unsafe workflow-run checkout patterns, floating runner/action pins, and major-only core action pins. <!-- @impl: packages/router-worker/scripts/workflow-safety.mjs::validateWorkflowSafety --> <!-- @test: packages/router-worker/src/workflows.test.ts (REQ-REL-004 rejects unsafe workflow_run checkout, floating actions, and floating runners) -->
