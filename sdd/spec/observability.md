...
2. Heartbeat metrics include mesh ID, mesh role, peer count, split and stage state, stage/layer ownership, MeshLLM API and console readiness, and the MeshLLM version. <!-- @impl: packages/node-agent/cmd/inference-mesh-agent/main.go::runtimeMetrics --> <!-- @impl: packages/node-agent/cmd/inference-mesh-agent/main.go::applyMeshStatusMetrics --> <!-- @impl: packages/node-agent/internal/agent/meshllm_status.go::ParseMeshLLMStatus --> <!-- @test: packages/router-worker/src/router.test.ts (REQ-NODE-002 REQ-OBS-003 accepts authenticated heartbeats and stores node metrics) --> <!-- @test: packages/node-agent/cmd/inference-mesh-agent/main_test.go (TestREQNODE007HeartbeatMetricsCarryMeshState) -->
