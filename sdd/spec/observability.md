...
1. The node agent tees the managed runtime's stderr through a bounded ring, shared by mesh-llm and llama.cpp, that keeps the most recent error-looking line and reassembles lines split across writes; a non-error-leveled line is never captured without a hard error token, whether the level is spelled out as a whole word (so `backtrace` is not a level) or printed as llama.cpp's bare leading severity letter. <!-- @impl: packages/node-agent/internal/agent/meshllm_stderr.go::runtimeLog --> <!-- @impl: packages/node-agent/internal/agent/meshllm_stderr.go::letterLevelChatter --> <!-- @impl: packages/node-agent/internal/agent/meshllm_manager.go::launchMeshProcess --> <!-- @impl: packages/node-agent/internal/agent/llamacpp_manager.go::Start --> <!-- @test: packages/node-agent/internal/agent/meshllm_stderr_test.go (TestREQOBS011RuntimeLogCapturesLastErrorLine) --> <!-- @test: packages/node-agent/internal/agent/meshllm_stderr_test.go (TestREQOBS011RuntimeLogHandlesSplitWrites) --> <!-- @test: packages/node-agent/internal/agent/meshllm_stderr_test.go (TestREQOBS011RuntimeLogIgnoresNonErrorLevelLines) --> <!-- @test: packages/node-agent/internal/agent/meshllm_stderr_test.go (TestREQOBS011RuntimeLogLevelTokensMatchWholeWordsOnly) --> <!-- @test: packages/node-agent/internal/agent/meshllm_stderr_test.go (TestREQOBS011RuntimeLogIgnoresLlamaCppLetterLevelLines) -->
