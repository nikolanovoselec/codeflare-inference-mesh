...
5. The agent waits for the runtime readiness endpoint before reporting a managed profile as loaded. <!-- @impl: packages/node-agent/internal/agent/runtime.go::waitForRuntimeReady --> <!-- @test: packages/node-agent/internal/agent/agent_test.go (TestREQRUN003RuntimeReadinessProbeWaitsForModelEndpoint) -->
