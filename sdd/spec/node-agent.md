...
6. Before first claim, the agent persists a detected Mesh IP only when private-interface detection is unambiguous. <!-- @impl: packages/node-agent/internal/agent/config.go::ApplyDetectedMeshIP --> <!-- @test: packages/node-agent/internal/agent/agent_test.go (TestREQNODE002AppliesDetectedMeshIPBeforeClaim) -->
