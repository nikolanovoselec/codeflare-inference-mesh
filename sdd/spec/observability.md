...
1. Direct llama.cpp nodes surface runtime kind, llama.cpp version, context, parallel/slot state, prompt-cache settings, and cached-token count. <!-- @impl: packages/router-worker/src/router.ts::handleAdminStatus --> <!-- @impl: packages/router-worker/src/admin-ui-client.ts::openNodeDrawer --> <!-- @test: packages/router-worker/src/router.test.ts (REQ-ADM-006 REQ-OBS-012 REQ-RUN-011 REQ-RUN-013 keeps direct llama.cpp UI controls backed by admin API payloads) -->
